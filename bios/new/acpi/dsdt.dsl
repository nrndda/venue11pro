 ...
 *
 * Disassembly of dsdt.dat, Sun Sep 27 20:17:03 2015
 *
...
DefinitionBlock ("dsdt.aml", "DSDT", 2, "DELL  ", "CBX3   ", 0x00000003)
{
    ...
    Name (ACPH, 0xDE)
    Name (FTBL, 0x04)
    OperationRegion (GNVS, SystemMemory, 0x79C32A90, 0x031D)
                                        ...
                                        If ((_T_1 == 0x04))
                                        {
                                            If (((MICR == One) && (SPEK == One)))
                                            {
                                                Return (Buffer (0x24)
                                                {
                                                    ...
                                                    /* 0018 */  0x06, 0x00, 0x4A, 0x00, 0x28, 0x00, 0x01, 0x00,  /* ..J.(... */
                                                    /* 0020 */  0x27, 0x00, 0x00, 0x00                           /* '... */
                                                })
                                            }
                                            Else
                                            {
                                                If (((MICR == Zero) && (SPEK == Zero)))
                                                {
                                                    Return (Buffer (0x24)
                                                    {
                                                        /* 0000 */  0x04, 0x00, 0x00, 0xCE, 0x23, 0x00, 0x01, 0x00,  /* ....#... */
                                        ...
                                        Else
                                        {
                                            If ((_T_1 == 0x02))
                                            {
                                                Return (Buffer (0xF6)
                                                {
                                                    ...
                                                    /* 0028 */  0xAF, 0xCE, 0x01, 0x00, 0xA6, 0x00, 0x61, 0x15,  /* ......a. */
                                                    ...
                                                    /* 0070 */  0x69, 0x01, 0x01, 0x00, 0xB2, 0x00, 0x29, 0x1F,  /* i.....). */
                                            ...
                                            Else
                                            {
                                                If ((_T_1 == 0x03))
                                                {
                                                    Return (Buffer (0x42)
                                                    {
                                                        ...
                                                        /* 0020 */  0x80, 0xF4, 0x78, 0x00, 0x00, 0x00, 0x00, 0x01,  /* ..x..... */
                                                        /* 0028 */  0xF8, 0xF2, 0x78, 0x00, 0x00, 0x00, 0x00, 0x00,  /* ..x..... */
