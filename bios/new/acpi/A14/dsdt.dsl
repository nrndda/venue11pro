 ...
 *
 * Disassembly of dsdt.dat, Wed Nov 25 17:48:07 2015
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x0000B1E6 (45542)
 *     Revision         0x02
 *     Checksum         0xC0
 *     OEM ID           "DELL  "
 *     OEM Table ID     "CBX3   "
...
DefinitionBlock ("dsdt.aml", "DSDT", 2, "DELL  ", "CBX3   ", 0x00000003)
{
    ...
    Name (ACPH, 0xDE)
    Name (FTBL, 0x04)
    OperationRegion (GNVS, SystemMemory, 0x79C31A90, 0x031D)
                                ...
                                While (One)
                                {
                                    ...
                                    Else
                                    {
                                        If ((_T_1 == 0x04))
                                        {
                                            Return (Buffer (0x14)
                                            {
                                                /* 0000 */  0x02, 0x00, 0x00, 0xCE, 0x1D, 0x00, 0x01, 0x00,  /* ........ */
                                                /* 0008 */  0x87, 0x88, 0x01, 0x00, 0x1D, 0x00, 0x01, 0x00,  /* ........ */
                                                /* 0010 */  0x06, 0x00, 0x4A, 0x00                           /* ..J. */
                                            })
                                        }
                                        Else
                                        {
